...
export const routes: Routes = [
    ...
    {path:'equipes_cadastro/:tipo', component: Equipes_CadastroComponent },
    {path:'equipes_cadastro/:tipo/:firebaseId', component: Equipes_CadastroComponent },
    //{path:'equipes_detalhe/:firebaseId/:tipo', component: Equipes_DetalheComponent },
