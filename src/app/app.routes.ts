...
export const routes: Routes = [
    ...
    {path:'pessoas_detalhe', component: Pessoas_DetalheComponent },
    ...
    {path:'utensilios_detalhe', component: Utensilios_DetalheComponent },
    {path:'barracas', component: BarracasComponent },
    {path:'barracas_cadastro', component: Barracas_CadastroComponent },
    {path:'barracas_detalhe', component: Barracas_DetalheComponent },
];
